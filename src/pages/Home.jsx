      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4">
            ...
            >
              <h1
                className="  mr-[40px] mb-8 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug md:text-[45px] md:leading-snug"
              >
                Simplifying the search for in-home care
              </h1>
              <p
                className=" mx-auto mb-10 max-w-[600px] text-base text-[#e4e4e4] sm:text-lg sm:leading-relaxed md:text-xl md:leading-relaxed"
              >
                The patients' ability to function on their own and to independently take care of themselves
              </p>
              ...
              <div className="flex  gap-[25px] w-[60px] ml-[190px]  wow fadeInUp text-center" data-wow-delay=".3s">
                <img
                  src="https://media.istockphoto.com/id/890666042/vector/donate-drop-blood-logo-donor-concept-blood-icon-gray-vector-blood-drop-vector-design-element.jpg?s=612x612&w=0&k=20&c=xyp3S1za4vUUWCIheZS2LgZVi0YeZYEZGxBKRbpxn0M="
                  alt="image"
                  className="rounded-xl mx-auto w-full max-w-[250px] opacity-50 transition duration-300 ease-in-out hover:opacity-100"
                />
                 <img
                  src="https://w7.pngwing.com/pngs/670/451/png-transparent-grey-logistics-logo-delivery-courier-freight-transport-computer-icons-cargo-symbols-delivery-miscellaneous-angle-company.png"
                  alt="image"
                  className="rounded-xl mx-auto w-full max-w-[250px] opacity-50 transition duration-300 ease-in-out hover:opacity-100"
                />
                 <img
                  src="https://i.pinimg.com/736x/0d/de/20/0dde20a7173d78b75f997b6973247bdf.jpg"
                  alt="image"
                  className="rounded-xl mx-auto w-full max-w-[250px] opacity-50 transition duration-300 ease-in-out hover:opacity-100"
                />
                <img
                  src="https://graphicsfamily.com/wp-content/uploads/2020/08/Logo-Design-for-Child-Care-Company-on-metal-mockup-scaled.jpg"
                  alt="image"
                  className="rounded-xl mx-auto w-full max-w-[250px] opacity-50 transition duration-300 ease-in-out hover:opacity-100"
                />
                 <img
                  src="https://t3.ftcdn.net/jpg/03/02/32/04/360_F_302320475_UlHYY5DT6EacVZcXqUTuEdRb9QPzSl7n.jpg"
                  alt="image"
                  className="rounded-xl mx-auto w-full max-w-[250px] opacity-50 transition duration-300 ease-in-out hover:opacity-100"
                />
              </div>
          ...
          <div className="w-full px-4">
            ...
            >
              <div className="mt-16">
                <img
                  src="https://images.pexels.com/photos/3791664/pexels-photo-3791664.jpeg?cs=srgb&dl=pexels-andrea-piacquadio-3791664.jpg&fm=jpg"
                  alt="hero"
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mb-12 max-w-[620px] lg:mb-20">
              ...
              >
                Given the nature of their job, truly great caregivers are naturally dependable, compassionate, and trustworthy.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/4">
            <div className="wow fadeInUp group mb-12 bg-white" data-wow-delay=".1s">
              ...
              >
                ...
                ></span>
                <img src="https://media.istockphoto.com/id/890666042/vector/donate-drop-blood-logo-donor-concept-blood-icon-gray-vector-blood-drop-vector-design-element.jpg?s=612x612&w=0&k=20&c=xyp3S1za4vUUWCIheZS2LgZVi0YeZYEZGxBKRbpxn0M="></img>
                <svg
                  width="35"
                  height="35"
                  viewBox="0 0 52 52"
            ...
            >
              ...
              >
                <span
                  className="absolute top-0 left-0 z-[-1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-2xl bg-primary bg-opacity-20 duration-300 group-hover:rotate-45"
                ></span>
                 <img src="https://w7.pngwing.com/pngs/670/451/png-transparent-grey-logistics-logo-delivery-courier-freight-transport-computer-icons-cargo-symbols-delivery-miscellaneous-angle-company.png"></img>
                ...
                <svg
                  ...
                  viewBox="0 0 52 52"
                  fill="none"
                  xmlns="https://w7.pngwing.com/pngs/670/451/png-transparent-grey-logistics-logo-delivery-courier-freight-transport-computer-icons-cargo-symbols-delivery-miscellaneous-angle-company.png"
                >
                  <path
            ...
            <div className="wow fadeInUp group mb-12 bg-white" data-wow-delay=".2s">
              ...
              >
                <span
                  className="absolute top-0 left-0 z-[-1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-2xl bg-primary bg-opacity-20 duration-300 group-hover:rotate-45"
                ></span>
                <img src="https://i.pinimg.com/736x/0d/de/20/0dde20a7173d78b75f997b6973247bdf.jpg"></img>
                <svg
                  width="35"
                  height="35"
                  viewBox="0 0 35 35"
            ...
            >
              ...
              >
                <span
                  className="absolute top-0 left-0 z-[-1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-2xl bg-primary bg-opacity-20 duration-300 group-hover:rotate-45"
                ></span>
                <img src="https://t3.ftcdn.net/jpg/03/02/32/04/360_F_302320475_UlHYY5DT6EacVZcXqUTuEdRb9QPzSl7n.jpg"/>
                <svg
                  width="35"
                  height="35"
                  viewBox="0 0 35 35"
              ...
              <h4 className="mb-3 text-xl font-bold text-dark">
                Provide quality home care
              </h4>
              <p className="mb-8 text-body-color lg:mb-11">
                The home health care services to kids and senior citizen.
              </p>
              <a
                href="/signup"
                className="text-base font-medium text-body-color hover:text-primary"
            ...
            <div className="w-full px-4">
              ...
              >
                ...
                >
                  ...
                  <h2
                    className="mb-6 text-1xl font-bold text-dark sm:text-4xl sm:leading-snug 2xl:text-[40px]"
                  >
                    Our website provide best services and excellent caregiver facility.
                  </h2>
                  <p className="mb-9 text-base leading-relaxed text-body-color">
                    
                  </p>
                  <p className="mb-9 text-base leading-relaxed text-body-color">
                 Every individuals who require assistance with daily activities and personal care receive support in a safe and supervised environment. 
                 <br></br>
                 <p>Our website is a perfect platform for getting services at the time of any medical emergency.
Our website provides services and facilities including cooking, transportation, physiotherapy, kids and senior care services.</p>
          ...
          <div className="w-full px-4">
            <div className="mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20">
              ...
              <p
                className="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed"
              >
               You can ask any question. We like to answer your every single concern we will try to answer your question within a week. 
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="w-full px-4 lg:w-1/2">
              ...
              <button className="faq-btn flex w-full items-center text-left">
                ...
                <div className="w-full">
                  <h4 className="text-base font-semibold text-black sm:text-lg">
                    How to use Beyond Infinity website?
                  </h4>
                </div>
              </button>
            ...
            >
              <button className="faq-btn flex w-full items-center text-left">
                ...
                <div className="w-full">
                  <h4 className="text-base font-semibold text-black sm:text-lg">
                    How to utilize different services?
                  </h4>
                </div>
              </button>
              <div className="faq-content hidden pl-[62px]">
          ...
          <div className="w-full px-4 lg:w-1/2">
            ...
            >
              <button className="faq-btn flex w-full items-center text-left">
                ...
                <div className="w-full">
                  <h4 className="text-base font-semibold text-black sm:text-lg">
                    How caregiver will get benefit by using website?
                  </h4>
                </div>
              </button>
              <div className="faq-content hidden pl-[62px]">
            ...
            >
              <button className="faq-btn flex w-full items-center text-left">
                ...
                <div className="w-full">
                  <h4 className="text-base font-semibold text-black sm:text-lg">
                    How much we have to pay for each service?
                  </h4>
                </div>
              </button>
              <div className="faq-content hidden pl-[62px]">
        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div className="wow fadeInUp mb-10" data-wow-delay=".15s">
              ...
              <div className="text-center">
                <h4 className="mb-2 text-lg font-medium text-dark">Hardik Tajne</h4>
                <p className="mb-5 text-sm font-medium text-body-color">
                  Front end developer
                </p>
                <div className="flex items-center justify-center">
              ...
              <div className="mb-12 flex flex-wrap justify-between lg:mb-0">
                ...
                <div className="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    ...
                    <p className="text-base text-body-color">beyondInfinity@gmial.com</p>
                    <p className="text-base text-body-color">
              ...
              <form>
                ...
                <div className="mb-6">
                  ...
                  <input
                    type="email"
                    name="email"
                    placeholder="beyondInfinity@gmail.com"
                    className="w-full border-0 border-b border-[#f1f1f1] py-4 focus:border-primary focus:outline-none"
                  />
                </div>
                <div className="mb-6">
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="mb-7 text-base text-[#f3f4fe]">
                We created caregiver service platform for elder and needy person by using
                technology.
              </p>
              ...
              <ul>
                ...
                <li>
                  <a
                    ...
                    className="mb-2 inline-block text-base leading-loose text-[#f3f4fe] hover:text-primary"
                  >
                   Kid and elder home care services
                  </a>
                </li>
                <li>
                  <a
